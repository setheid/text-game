...
class Frog extends Character {
  constructor(name, damage, hp) { // I couldn't set default arguments, like (name = 'default'). Maybe not supported in Chrome?
    var name = typeof name !== 'undefined' ?  name : 'a small ugly frog';
    var damage = typeof damage !== 'undefined' ?  damage : 2;
    var hp = typeof hp !== 'undefined' ?  hp : 10;
...
class GiantFrog extends Frog {
  constructor() {
    super('Grog the Frog', 100, 300);
  }
}
